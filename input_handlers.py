...
class AskUderEventHandler(EventHandler):
...
class InventoryEventHandler(AskUderEventHandler):
    ...
    def on_render(self, console: tcod.Console) -> None:
        """Render an inventory meny, which displays the items in the inventory,
    ...
    def ev_keydown(self, event: tcod.event.KeyDown) -> None:
        ...
        if event.sym in CURSOR_Y_KEYS:
            ...
            if adjust < 0 and self.cursor == 0:
                ...
                # otherwise move while staying clamped to bounds of history
